...
const SECTIONS_TENANT: { label: string; items: NavItem[] }[] = [
    {
        label: 'Trabalho',
        items: [
            { label: 'Hoje', routeName: 'tenant.dashboard', path: '/painel', icon: 'M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z M9 22V12h6v10' },
            { label: 'Agenda', routeName: 'tenant.agenda', path: '/painel/agenda', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', ocultoEmTriagem: true, activePaths: ['/painel/agenda', '/painel/agendamentos'] },
    ...
    },
    {
        label: 'Gestão',
        items: [
            { label: 'Desempenho', routeName: 'tenant.analytics', path: '/painel/analytics', planos: ['pro', 'business'], adminOnly: true, icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 00-2-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2 2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
        ],
    },
    {
        label: 'Sistema',
...
export default function Sidebar({
    ...
    return (
        <>
            ...
            {open && (
                <div
                    className="fixed inset-0 z-20 bg-black/60 backdrop-blur-sm lg:hidden" aria-hidden="true"
                    onClick={onClose}
                />
            )}
