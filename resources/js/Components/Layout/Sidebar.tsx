...
import { TIPOS_COM_RECURSOS, TIPOS_COM_PROFISSIONAIS } from '@/lib/tenantNav';
...
const SECTIONS_TENANT: { label: string; items: NavItem[] }[] = [
    ...
    },
    {
        label: 'Configurar',
        items: [
            { label: 'Recursos',      routeName: 'tenant.recursos.index',     path: '/painel/recursos',      icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4',      tipos: TIPOS_COM_RECURSOS },
            { label: 'Profissionais', routeName: 'tenant.profissionais.index', path: '/painel/profissionais', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z', tipos: TIPOS_COM_PROFISSIONAIS },
            { label: 'Serviços',      routeName: 'tenant.servicos.index',      path: '/painel/servicos',      icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4',      tipos: TIPOS_COM_PROFISSIONAIS },
