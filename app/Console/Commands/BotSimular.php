    ...
    public function handle(): int
    {
        ...
        while (true) {
            ...
            try {
                ...
                app()->call([$job, 'handle'], [
                    'claude'            => app(\App\Services\ClaudeAgentService::class),
                    'agendamentoService' => app(\App\Services\AgendamentoService::class),
                    'evolution'         => app(\App\Services\EvolutionApiService::class),
                    'intencao'          => app(\App\Services\IntencaoService::class),
                ]);
            } catch (\Throwable $e) {
