...
class AgendamentoTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Mock pg_advisory_xact_lock — SQLite não suporta esta função
        DB::shouldReceive('select')
            ->withArgs(fn ($sql) => str_contains($sql, 'pg_advisory_xact_lock'))
            ->andReturn([]);
    ...
    public function test_rejeita_double_booking(): void
    {
        ...
        // Tentar criar conflitante no mesmo horário
        $this->service->criar([
            'tenant_id'        => $this->tenant->id,
            'cliente_nome'     => 'Pedro',
